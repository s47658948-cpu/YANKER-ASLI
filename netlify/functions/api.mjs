...
async function getData(key) {
  try {
    ...
    throw new Error(
      "Netlify Blobs را نتوانستیم بخوانیم. در Netlify بخش Blobs را برای این سایت فعال کن."
    );
  }
}
...
async function setData(key, value) {
  try {
    ...
    throw new Error(
      "Netlify Blobs برای ذخیره‌سازی فعال نیست. در Netlify بخش Blobs را برای این سایت فعال کن."
    );
  }
}
